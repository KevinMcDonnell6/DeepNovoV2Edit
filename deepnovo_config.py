...
parser.add_argument("--beam_size", type=int, default="1")#changed from 5
...
train_stack_size = 200 # 3000 # 5000
valid_stack_size = 200#1500#1000 # 3000 # 5000
test_stack_size = 200#5000
decode_stack_size = 200#1000 # 3000
...
#input_spectrum_file_train = "MSV000081382/cross.9high_80k.exclude_yeast/spectrum.mgf"
#input_feature_file_train = "MSV000081382/cross.9high_80k.exclude_yeast/features.train.csv"
#input_spectrum_file_valid = "MSV000081382/cross.9high_80k.exclude_yeast/spectrum.mgf"
#input_feature_file_valid = "MSV000081382/cross.9high_80k.exclude_yeast/features.valid.csv"
...
#denovo_input_spectrum_file = "MSV000081382/cross.9high_80k.exclude_yeast/spectrum.mgf"
#denovo_input_feature_file = "MSV000081382/cross.9high_80k.exclude_yeast/features.test.csv"
